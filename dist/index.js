...
</svg>`,t.style.marginLeft="10px",t.style.cursor="pointer",t.style.textDecoration="underline",t.addEventListener("click",function(a){a.preventDefault(),navigator.clipboard.writeText(e.textContent??"").then(()=>{console.log("Copied: "+e.textContent)}).catch(n=>{console.error("Failed to copy: ",n)})}),(r=e.parentNode)==null||r.appendChild(t)})});const c=document.createElement("style");c.innerHTML=d;document.head.appendChild(c);setTimeout(()=>{const e=document.createElement("iframe");e.src="https://github.com/simplicate-software/frontend/actions?query=actor:joosthobmasimplicate",document.body.append(e)});
