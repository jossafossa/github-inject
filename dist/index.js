...
`,c=async e=>new Promise(n=>{const o=setInterval(()=>{const a=document.querySelector(e);a&&(clearInterval(o),n(a))},100)}),d=(...e)=>{console.log("%c[github-extensions]%c","color: #f0db4f; font-weight: bold; background: #323330; padding: 2px 5px; border-radius: 3px;","color: #fff; font-weight: normal; background: #323330; padding: 2px 5px; border-radius: 3px;",...e)},l=document.createElement("style");l.innerHTML=y;document.head.appendChild(l);const v=async()=>{d("github loaded"),u(),b(),m()};c(".timeline-comment-group").then(v);const w=async()=>{d("pipeline loaded"),g()};c("[class*='MergeBoxSectionHeader-module__wrapper']").then(w);
