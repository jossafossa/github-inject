...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();const m=()=>{document.querySelectorAll("details-collapsible summary a").forEach(e=>{var o;let t=document.createElement("span");t.innerHTML=`<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copy">
    <path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path>
</svg>`,t.style.marginLeft="10px",t.style.cursor="pointer",t.style.textDecoration="underline",t.addEventListener("click",function(a){a.preventDefault(),navigator.clipboard.writeText(e.textContent??"").then(()=>{console.log("Copied: "+e.textContent)}).catch(n=>{console.error("Failed to copy: ",n)})}),(o=e.parentNode)==null||o.appendChild(t)})},i="lock-merge",h=()=>{const e=document.createElement("input");e.type="checkbox",e.id="lock-merge",document.body.appendChild(e),localStorage.getItem(i)==="checked"&&(e.checked=!0),e.addEventListener("change",()=>{localStorage.setItem(i,e.checked?"checked":"unchecked")})},u=()=>{const e=document.querySelector(".partial-pull-merging-analytics-js section + div");if(!e)return;const t=document.createElement("div");e.prepend(t),t.classList.add("fs-messages");const o=document.createElement("a");o.href="https://github.com/simplicate-software/frontend/actions?query=actor:joosthobmasimplicate",o.innerText="Actions of this PR",t.append(o)},p=()=>{u()},g=()=>document.querySelector(".gh-header-meta [title='Status: Merged']")?"merged":document.querySelector("[reviewable_state='draft']")?"draft":document.querySelector("[data-name*='QA-Test'], [data-name*='qa-test']")?"test":!1,f=()=>{let e=!1;const t=setInterval(()=>{const o=g();if(e!==o&&o){const a=`[${o.toUpperCase()}]`;e=!!o;const n=document.querySelector("h1 > bdi");n&&(n.innerHTML=`${a} ${n.innerHTML}`),document.title=`${a} ${document.title}`,clearInterval(t)}},1e3)},b=`/*
Comments:
...
`,c=async e=>new Promise(t=>{const o=setInterval(()=>{const a=document.querySelector(e);a&&(clearInterval(o),t(a))},100)}),d=(...e)=>{console.log("%c[github-extensions]%c","color: #f0db4f; font-weight: bold; background: #323330; padding: 2px 5px; border-radius: 3px;","color: #fff; font-weight: normal; background: #323330; padding: 2px 5px; border-radius: 3px;",...e)},l=document.createElement("style");l.innerHTML=b;document.head.appendChild(l);const y=async()=>{d("github loaded"),h(),f(),m()};c(".timeline-comment-group").then(y);const v=async()=>{d("pipeline loaded"),p()};c("[class*='MergeBoxSectionHeader-module__wrapper']").then(v);
