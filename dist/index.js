...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(e){if(e.ep)return;e.ep=!0;const o=r(e);fetch(e.href,o)}})();const i="lock-merge",l=()=>{const n=document.createElement("input");n.type="checkbox",n.id="lock-merge",document.body.appendChild(n),localStorage.getItem(i)==="checked"&&(n.checked=!0),n.addEventListener("change",()=>{localStorage.setItem(i,n.checked?"checked":"unchecked")})},m=()=>{const n=document.querySelector(".partial-pull-merging-analytics-js section + div");if(!n)return;const t=document.createElement("a");t.href="https://github.com/simplicate-software/frontend/actions?query=actor:joosthobmasimplicate",t.innerText="Actions of this PR",n.append(t)},u=()=>{m()},h=()=>document.querySelector(".gh-header-meta [title='Status: Merged']")?"merged":document.querySelector("[reviewable_state='draft']")?"draft":document.querySelector("[data-name*='QA-Test'], [data-name*='qa-test']")?"test":!1,g=()=>{let n=!1;const t=setInterval(()=>{const r=h();if(n!==r&&r){const a=`[${r.toUpperCase()}]`;n=!!r;const e=document.querySelector("h1 > bdi");e&&(e.innerHTML=`${a} ${e.innerHTML}`),document.title=`${a} ${document.title}`,clearInterval(t)}},1e3)},p=`/*
Comments:
...
`,c=async n=>new Promise(t=>{const r=setInterval(()=>{const a=document.querySelector(n);a&&(clearInterval(r),t(a))},100)}),d=document.createElement("style");d.innerHTML=p;document.head.appendChild(d);const f=async()=>{console.log("github loaded"),l(),g()};c(".timeline-comment-group").then(f);const b=async()=>{console.log("pipeline loaded"),u()};c("[class*='MergeBoxSectionHeader-module__wrapper']").then(b);
