...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function o(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=o(e);fetch(e.href,r)}})();const l=()=>{document.querySelectorAll("details-collapsible summary a").forEach(n=>{var o;let t=document.createElement("span");t.innerHTML=`<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copy">
    <path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path>
</svg>`,t.style.marginLeft="10px",t.style.cursor="pointer",t.style.textDecoration="underline",t.addEventListener("click",function(a){a.preventDefault(),navigator.clipboard.writeText(n.textContent??"").then(()=>{console.log("Copied: "+n.textContent)}).catch(e=>{console.error("Failed to copy: ",e)})}),(o=n.parentNode)==null||o.appendChild(t)})},i="lock-merge",m=()=>{const n=document.createElement("input");n.type="checkbox",n.id="lock-merge",document.body.appendChild(n),localStorage.getItem(i)==="checked"&&(n.checked=!0),n.addEventListener("change",()=>{localStorage.setItem(i,n.checked?"checked":"unchecked")})},h=()=>{const n=document.querySelector(".partial-pull-merging-analytics-js section + div");if(!n)return;const t=document.createElement("a");t.href="https://github.com/simplicate-software/frontend/actions?query=actor:joosthobmasimplicate",t.innerText="Actions of this PR",n.append(t)},u=()=>{h()},p=()=>document.querySelector(".gh-header-meta [title='Status: Merged']")?"merged":document.querySelector("[reviewable_state='draft']")?"draft":document.querySelector("[data-name*='QA-Test'], [data-name*='qa-test']")?"test":!1,g=()=>{let n=!1;const t=setInterval(()=>{const o=p();if(n!==o&&o){const a=`[${o.toUpperCase()}]`;n=!!o;const e=document.querySelector("h1 > bdi");e&&(e.innerHTML=`${a} ${e.innerHTML}`),document.title=`${a} ${document.title}`,clearInterval(t)}},1e3)},f=`/*
Comments:
...
`,c=async n=>new Promise(t=>{const o=setInterval(()=>{const a=document.querySelector(n);a&&(clearInterval(o),t(a))},100)}),d=document.createElement("style");d.innerHTML=f;document.head.appendChild(d);const b=async()=>{console.log("github loaded"),m(),g(),l()};c(".timeline-comment-group").then(b);const y=async()=>{console.log("pipeline loaded"),u()};c("[class*='MergeBoxSectionHeader-module__wrapper']").then(y);
