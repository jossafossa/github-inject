...
</svg>`,n.style.marginLeft="10px",n.style.cursor="pointer",n.style.textDecoration="underline",n.addEventListener("click",function(a){a.preventDefault(),navigator.clipboard.writeText(e.textContent??"").then(()=>{console.log("Copied: "+e.textContent)}).catch(t=>{console.error("Failed to copy: ",t)})}),(r=e.parentNode)==null||r.appendChild(n)})});const c=document.createElement("style");c.innerHTML=d;document.head.appendChild(c);setTimeout(()=>{const e=document.querySelector(".partial-pull-merging-analytics-js section + div");if(!e)return;const n=document.createElement("a");n.href="https://github.com/simplicate-software/frontend/actions?query=actor:joosthobmasimplicate",n.innerText="Actions of this PR",e.append(n)},1e3);
